        ...
        <div className="container relative mx-auto px-4 py-24 z-20">
          <AnimatedElement type="fadeIn" delay={0.2}>
            <div className="inline-flex items-center space-x-2 mb-4">
              ...
              <span className="text-red-400 uppercase tracking-wider text-sm font-semibold">Ages 11-13</span>
              <div className="h-px w-8 bg-red-500"></div>
            </div>
          ...
          <AnimatedElement type="fadeIn" delay={0.3}>
            <p className="text-xl text-gray-200 max-w-xl leading-relaxed">
              ...
              designed for adolescent development.
            </p>
          </AnimatedElement>
        </div>
      </div>
        ...
        <AnimatedElement type="fadeIn" delay={0.7}>
          <div className="relative rounded-xl overflow-hidden mb-8">
            ...
            <div className="relative z-10 p-10 text-center">
              <h2 className="text-3xl font-bold text-white mb-4">Help Your Teen Develop Confidence and Character</h2>
